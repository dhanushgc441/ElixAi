...
const ChatView = ({ chat, isGenerating, onSendMessage, onNewChat, onToggleSidebar }) => {
    ...
    const handleImageChange = (e) => {
        ...
        reader.onloadend = () => {
            // FIX: Add type guard to ensure reader.result is a string before splitting.
    ...
    const handleDownload = (inlineData) => {
                                            ...
                                            <div className="prose prose-invert prose-p:my-0 flex flex-col gap-4">
                                                {msg.parts.map((part, partIndex) => {
                                                    ...
                                                    if (part.text || part.text === '') {
                                                        return <div key={partIndex} dangerouslySetInnerHTML={{ __html: marked.parse(part.text) }} />;
                                                    }
                                                    return null;
                                                })}
                                            </div>
